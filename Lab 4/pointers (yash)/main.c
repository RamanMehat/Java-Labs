...
static void test_cube_area_volume(void)
{
    ...
    sput_fail_unless(fabs(a - 24.0) < 0.001, "cube_area_volume(2, &a, &v)"
                                             " a ==> 24.0"); 
    sput_fail_unless(fabs(v - 8.0) < 0.001, "cube_area_volume(2, &a, &v)"
                                            " v ==> 8.0"); 
}
